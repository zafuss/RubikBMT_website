...
INSERT INTO `student` (`id`, `date_of_birth`, `email`, `first_name`, `image_url`, `last_name`, `learning_type`, `parent_name`, `phone_number`, `mentor_id`, `full_name`, `learning_type_id`, `confirmation_date`, `note`, `registration_date`) VALUES
